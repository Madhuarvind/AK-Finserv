...
class RiskEngine:
    ...
    def _train_cold_start(self):
        ...
        X_good = np.column_stack([good_missed, good_overdue, good_recency, good_partial, good_util])
        ...
        X_bad = np.column_stack([bad_missed, bad_overdue, bad_recency, bad_partial, bad_util])
    ...
    def predict_risk(self, missed_emis, max_overdue_days, days_since_pay, partial_score, utilization_approx=50):
        """
        Returns:
        ...
        features = np.array([[missed_emis, max_overdue_days, days_since_pay, partial_score, utilization_approx]])
